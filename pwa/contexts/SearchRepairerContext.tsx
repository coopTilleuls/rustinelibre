...
export const SearchRepairerContext = createContext<SearchRepairerContext>(initialValue);

export const SearchRepairerProvider = ({ children }: ProviderProps): JSX.Element => {
