...
// tarteaucitron.user.googletagmanagerId = 'G-FYSMJJGX06';
// (tarteaucitron.job = tarteaucitron.job || []).push('googletagmanager');

tarteaucitron.services.customRecaptcha = {
  key: 'customRecaptcha',
  type: 'api',
  name: 'Recaptcha',
  needConsent: true,
  ...
  js: function () {},
  fallback: function () {},
  readmoreLink: '/protection-des-donnees',
};
(tarteaucitron.job = tarteaucitron.job || []).push('customRecaptcha');
