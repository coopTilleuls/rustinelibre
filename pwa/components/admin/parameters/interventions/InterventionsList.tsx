...
export const InterventionsList = (): JSX.Element => {
    ...
    const [selectedInterventionToDelete, setSelectedInterventionToDelete] = useState<Intervention|null>(null);
    ...
    return (
        <Box>
                        ...
                        {interventions.map((intervention) => (
                            <TableRow
                                ...
                                <TableCell align="right">
                                    <Link href={`/admin/parametres/interventions/edit/${intervention.id}`}>
                                        <EditIcon sx={{color: '#8c83ba', fontSize: '2em', cursor: 'pointer'}} />
                                    </Link>
                                    <DeleteIcon onClick={() => handleDeleteClick(intervention)} sx={{color: '#8c83ba', fontSize: '2em', cursor: 'pointer'}} />
                                </TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
            ...
            {
                selectedInterventionToDelete && <Dialog
