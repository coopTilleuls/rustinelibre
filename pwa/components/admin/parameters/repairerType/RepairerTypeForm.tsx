...
const RepairerTypeForm = ({repairerType}: RepairerTypeFormProps): JSX.Element => {
    ...
    return (
            <Box
                ...
                {success && <Alert sx={{marginTop: '10px'}} severity="success">Type de réparateur mis à jour</Alert>}
            </Box>
    );
};
