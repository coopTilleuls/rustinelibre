...
export const AutoDiagnosticTunnel = ({appointmentId}: AutoDiagnosticTunnelProps): JSX.Element => {
    ...
    async function fetchAppointment() {
        if (appointmentId) {
            setLoading(true);
            const appointmentFetched = await appointmentResource.getById(appointmentId);
