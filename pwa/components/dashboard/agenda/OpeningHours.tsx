...
export const OpeningHours = ({repairer}: OpeningHoursProps): JSX.Element => {
  ...
  const [duration, setDuration] = useState<number>(
    repairer.durationSlot ? repairer.durationSlot : 60
  );
  const [numberOfSlots, setNumberOfSlots] = useState<number>(
    repairer.numberOfSlots ? repairer.numberOfSlots : 1
  );
  ...
  return (
    <>
      ...
      <Box sx={{marginTop: '80px'}}>
        <Typography variant="h5">Gestion des créneaux horaires</Typography>
        ...
        <FormControl
          ...
          <InputLabel id="nb-slots-accepted-label">
            Nombre de RDV accepté par créneau
          </InputLabel>
          <Select
            id="nb-slots-accepted"
            labelId="nb-slots-accepted-label"
