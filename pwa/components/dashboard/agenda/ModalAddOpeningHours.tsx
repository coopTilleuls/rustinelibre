...
const ModalAddOpeningHours = ({day, openModal, handleCloseModal}: ModalAddOpeningHoursProps): JSX.Element => {
            ...
            <Box sx={style}>
                <Box sx={{ mt: 1 }}>
                    ...
                    <Box sx={{display: 'flex', marginLeft: '20%'}}>
                        <Box>
                            <InputLabel id="demo-simple-select-label">Horaire d&apos;ouverture</InputLabel>
                            <Select
                        ...
                        <Box sx={{marginLeft: '90px'}}>
                            <InputLabel id="demo-simple-select-label">Horaire de fermeture</InputLabel>
                            <Select
                                labelId="demo-simple-select-label"
                                id="demo-simple-select"
                                value={endTime}
                    ...
                    >
                        {!pendingAdd ? 'Ajouter cette plage horaire' : <CircularProgress size={20} />}
                    </Button>
                    {errorMessage && (
