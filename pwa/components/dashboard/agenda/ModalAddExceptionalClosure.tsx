...
const ModalAddExceptionalClosure = ({openModal, handleCloseModal}: ModalAddExceptionalClosureProps): JSX.Element => {
    ...
    const handleSubmit = async (): Promise<void> => {
        ...
        try {
            ...
            setErrorMessage('Ajout impossible, vérifiez les dates indiquées');
        }
        ...
        >
            <Box sx={style}>
                <Box sx={{ mt: 1 }}>
                    ...
                    >
                        {!pendingAdd ? 'Ajouter cette période' : <CircularProgress size={20} />}
                    </Button>
                    {errorMessage && (
