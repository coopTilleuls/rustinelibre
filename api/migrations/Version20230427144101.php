...
final class Version20230427144101 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_90E16CB2E5B533F9 ON auto_diagnostic (appointment_id)');
        $this->addSql('CREATE INDEX IDX_90E16CB27E9E4C8C ON auto_diagnostic (photo_id)');
        $this->addSql('ALTER TABLE auto_diagnostic ADD CONSTRAINT FK_90E16CB2E5B533F9 FOREIGN KEY (appointment_id) REFERENCES appointment (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
