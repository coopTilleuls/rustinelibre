...
final class Version20230325193849 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE repairer (id INT NOT NULL, owner_id INT NOT NULL, repairer_type_id INT DEFAULT NULL, thumbnail_id INT DEFAULT NULL, description_picture_id INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, mobile_phone VARCHAR(255) DEFAULT NULL, street VARCHAR(800) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, postcode VARCHAR(255) DEFAULT NULL, country VARCHAR(255) DEFAULT NULL, rrule VARCHAR(255) DEFAULT NULL, latitude VARCHAR(255) DEFAULT NULL, longitude VARCHAR(255) DEFAULT NULL, first_slot_available TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, opening_hours TEXT DEFAULT NULL, optional_page TEXT DEFAULT NULL, enabled BOOLEAN NOT NULL, comment TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE appointment ADD CONSTRAINT FK_FE38F84447C5DFEE FOREIGN KEY (repairer_id) REFERENCES repairer (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE repairer_employee ADD CONSTRAINT FK_2A8FCF0647C5DFEE FOREIGN KEY (repairer_id) REFERENCES repairer (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE repairer_employee ADD CONSTRAINT FK_2A8FCF068C03F15C FOREIGN KEY (employee_id) REFERENCES "user" (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
