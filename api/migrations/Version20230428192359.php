...
final class Version20230428192359 extends AbstractMigration
{
    ...
    {
        return 'Set repairer description picture and thumbnail null if deleted';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE repairer ADD CONSTRAINT FK_4A73F2BFFDFF2E92 FOREIGN KEY (thumbnail_id) REFERENCES media_object (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
