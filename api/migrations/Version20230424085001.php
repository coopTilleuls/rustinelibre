...
final class Version20230424085001 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bike (id INT NOT NULL, owner_id INT NOT NULL, bike_type_id INT DEFAULT NULL, picture_id INT DEFAULT NULL, wheel_picture_id INT DEFAULT NULL, transmission_picture_id INT DEFAULT NULL, brand VARCHAR(255) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, details TEXT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_4CBC37807E3C61F9 ON bike (owner_id)');
