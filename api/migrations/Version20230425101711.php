...
final class Version20230425101711 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE maintenance (id INT NOT NULL, owner_id INT NOT NULL, bike_id INT NOT NULL, image_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(3000) DEFAULT NULL, repair_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE INDEX IDX_2F84F8E93DA5256D ON maintenance (image_id)');
        ...
        $this->addSql('ALTER TABLE maintenance ADD CONSTRAINT FK_2F84F8E93DA5256D FOREIGN KEY (image_id) REFERENCES media_object (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
