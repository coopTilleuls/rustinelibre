...
class MediaObject
{
    ...
    #[Groups([self::MEDIA_OBJECT_READ, Repairer::REPAIRER_READ, Bike::READ, Maintenance::READ, Appointment::APPOINTMENT_READ, AutoDiagnostic::READ, Appointment::APPOINTMENT_READ, User::USER_READ])]
